...
class Container(BaseContainer):
    ...
    def exposes(self) -> Iterable[ExposeLink]:
        return [
            ...
            self.expose_public("GW1", "RouterNetwork", "主路由管理", self.load_nginx_url("PRIMARY_GATEWAY_DOMAIN")),
            self.expose_private("GW1", "RouterNetwork", "主路由管理", self.load_config_url("PRIMARY_GATEWAY_LOCAL_URL")),

            self.expose_public("GW2", "RouterNetwork", "旁路由管理", self.load_nginx_url("BYPASS_GATEWAY_DOMAIN")),
